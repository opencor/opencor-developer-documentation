...
- C++ toolchain: a set of C++ tools.
  ...
  - **Linux:** GCC/G++ 5.x and later (``g++-5``/``g++`` package on Ubuntu 16.04/18.04 LTS), as well as OpenGL (``mesa-common-dev`` package) on Ubuntu; and
  - **macOS:** `Xcode <https://developer.apple.com/xcode/>`__ 9.3.1 (including the `Command Line Tools <https://developer.apple.com/downloads/?q=Command%20Line%20Tools>`__).
