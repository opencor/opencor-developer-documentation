...
- C++ toolchain: a set of C++ tools.
  ...
  - **macOS:** `Xcode <https://developer.apple.com/xcode/>`__ 9.3.1 (including the `Command Line Tools <https://developer.apple.com/downloads/?q=Command%20Line%20Tools>`__), as well as JPEG and PNG (``brew install jpeg libpng``).
