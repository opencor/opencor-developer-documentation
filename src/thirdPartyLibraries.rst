...
- `KaTeX <https://katex.org/>`__ 0.15.3: the fastest math typesetting library for the Web.
...
- `libgit2 <https://libgit2.org/>`__ 1.4.2: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `OpenSSL <https://openssl.org/>`__ 3.0.2: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `QScintilla <https://riverbankcomputing.com/software/qscintilla/intro>`__ 2.13.2: a `Qt <https://qt.io/>`__ port of the `Scintilla <https://scintilla.org/>`__ editing component.
...
- `SUNDIALS <https://computing.llnl.gov/projects/sundials>`__ 6.1.1: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
