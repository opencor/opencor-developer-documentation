...
- `LLVM <https://llvm.org/>`__\ +\ `Clang <https://clang.llvm.org/>`__ 10.0.0: a collection of modular and reusable compiler and toolchain technologies.
...
- `OpenSSL <https://openssl.org/>`__ 1.1.1g: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `Oxygen <https://packages.ubuntu.com/groovy/oxygen-icon-theme>`__ 5.71.0: icons used in various parts of OpenCOR.
