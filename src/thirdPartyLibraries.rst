...
- `Mesa <https://www.mesa3d.org/>`__ 18.2.7: a system for rendering interactive 3D graphics.
...
- `Oxygen <https://packages.ubuntu.com/disco/oxygen-icon-theme>`__ 5.53.0: icons used in various parts of OpenCOR.
...
- `SUNDIALS <https://computation.llnl.gov/projects/sundials>`__ 4.0.0: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
