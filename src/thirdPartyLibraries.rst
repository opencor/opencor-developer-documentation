...
- `libgit2 <https://libgit2.github.com/>`__ 0.27.1: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `LLVM <http://www.llvm.org/>`__\ +\ `Clang <http://clang.llvm.org/>`__ 6.0.1 a collection of modular and reusable compiler and toolchain technologies.
...
- `OpenSSL <https://www.openssl.org/>`__ 1.0.2o: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `Oxygen <https://packages.ubuntu.com/cosmic/oxygen-icon-theme>`__ 5.47.0: icons used in various parts of OpenCOR.
...
- `SUNDIALS <http://computation.llnl.gov/projects/sundials>`__ 3.1.1: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
