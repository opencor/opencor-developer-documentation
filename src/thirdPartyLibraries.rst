...
- `libgit2 <https://libgit2.github.com/>`__ 1.0.1: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `LLVM <https://llvm.org/>`__\ +\ `Clang <https://clang.llvm.org/>`__ 10.0.1: a collection of modular and reusable compiler and toolchain technologies.
...
- `Mesa <https://mesa3d.org/>`__ 20.1.2: a system for rendering interactive 3D graphics.
...
- `OpenSSL <https://openssl.org/>`__ 1.1.1h: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `Oxygen <https://packages.ubuntu.com/groovy/oxygen-icon-theme>`__ 5.74.0: icons used in various parts of OpenCOR.
...
- `SUNDIALS <https://computation.llnl.gov/projects/sundials>`__ 5.3.0: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
