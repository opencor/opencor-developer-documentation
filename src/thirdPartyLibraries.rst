...
- `libgit2 <https://libgit2.github.com/>`__ 0.27.8: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `LLVM <https://llvm.org/>`__\ +\ `Clang <https://clang.llvm.org/>`__ 7.0.1: a collection of modular and reusable compiler and toolchain technologies.
...
- `Mesa <https://www.mesa3d.org/>`__ 18.3.3: a system for rendering interactive 3D graphics.
...
- `Oxygen <https://packages.ubuntu.com/disco/oxygen-icon-theme>`__ 5.54.0: icons used in various parts of OpenCOR.
...
- `QScintilla <https://riverbankcomputing.com/software/qscintilla/intro>`__ 2.11: a `Qt <https://www.qt.io/>`__ port of the `Scintilla <https://www.scintilla.org/>`__ editing component.
