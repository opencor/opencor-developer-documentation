...
- `KaTeX <https://katex.org/>`__ 0.13.13: the fastest math typesetting library for the Web.
...
- `libgit2 <https://libgit2.github.com/>`__ 1.1.1: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `Mesa <https://mesa3d.org/>`__ 21.2.0: a system for rendering interactive 3D graphics.
...
- `Oxygen <https://packages.ubuntu.com/impish/oxygen-icon-theme>`__ 5.85.0: icons used in various parts of OpenCOR.
