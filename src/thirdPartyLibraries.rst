...
- `KaTeX <https://katex.org/>`__ 0.11.0: the fastest math typesetting library for the Web.
...
- `libgit2 <https://libgit2.github.com/>`__ 0.28.2: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `Mesa <https://www.mesa3d.org/>`__ 19.1.1: a system for rendering interactive 3D graphics.
...
- `OpenSSL <https://www.openssl.org/>`__ 1.0.2s: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `Oxygen <https://packages.ubuntu.com/eoan/oxygen-icon-theme>`__ 5.59.0: icons used in various parts of OpenCOR.
...
- `QScintilla <https://riverbankcomputing.com/software/qscintilla/intro>`__ 2.11.2: a `Qt <https://www.qt.io/>`__ port of the `Scintilla <https://www.scintilla.org/>`__ editing component.
