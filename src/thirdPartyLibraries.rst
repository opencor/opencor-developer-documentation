...
- `QScintilla <https://riverbankcomputing.com/software/qscintilla/intro>`__ 2.12.1: a `Qt <https://qt.io/>`__ port of the `Scintilla <https://scintilla.org/>`__ editing component.
