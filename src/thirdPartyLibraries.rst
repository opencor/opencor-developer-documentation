...
- `Mesa <https://www.mesa3d.org/>`__ 19.1.5: a system for rendering interactive 3D graphics.
...
- `Oxygen <https://packages.ubuntu.com/eoan/oxygen-icon-theme>`__ 5.61.0: icons used in various parts of OpenCOR.
