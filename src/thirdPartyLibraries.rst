...
- `libgit2 <https://libgit2.github.com/>`__ 0.28.4: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `Oxygen <https://packages.ubuntu.com/focal/oxygen-icon-theme>`__ 5.62.0: icons used in various parts of OpenCOR.
