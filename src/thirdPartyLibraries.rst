...
- `libgit2 <https://libgit2.github.com/>`__ 0.27.0: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `LLVM <http://www.llvm.org/>`__\ +\ `Clang <http://clang.llvm.org/>`__ 6.0.0 a collection of modular and reusable compiler and toolchain technologies.
