...
- `KaTeX <https://katex.org/>`__ 0.13.0: the fastest math typesetting library for the Web.
...
- `LLVM <https://llvm.org/>`__\ +\ `Clang <https://clang.llvm.org/>`__ 11.0.0: a collection of modular and reusable compiler and toolchain technologies.
...
- `Mesa <https://mesa3d.org/>`__ 21.0.1: a system for rendering interactive 3D graphics.
...
- `OpenSSL <https://openssl.org/>`__ 1.1.1i: a toolkit implementing the Secure Sockets Layer (SSL v2/v3) and Transport Layer Security (TLS) protocols, as well as a full-strength general purpose cryptography library.
...
- `Oxygen <https://packages.ubuntu.com/hirsute/oxygen-icon-theme>`__ 5.77.0: icons used in various parts of OpenCOR.
...
- `QScintilla <https://riverbankcomputing.com/software/qscintilla/intro>`__ 2.11.6: a `Qt <https://qt.io/>`__ port of the `Scintilla <https://scintilla.org/>`__ editing component.
...
- `Qwt <https://qwt.sourceforge.io/>`__ 6.1.5: a set of widgets and utility classes primarily aimed at programs with a technical background.
...
- `SUNDIALS <https://computation.llnl.gov/projects/sundials>`__ 5.6.1: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
