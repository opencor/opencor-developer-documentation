...
- `libgit2 <https://libgit2.github.com/>`__ 0.27.5: a portable, pure C implementation of the `Git <https://git-scm.com/>`__ core methods provided as a re-entrant linkable library with a solid API.
...
- `SUNDIALS <http://computation.llnl.gov/projects/sundials>`__ 3.2.0: a SUite of Non-linear and DIfferential/ALgebraic equation Solvers.
